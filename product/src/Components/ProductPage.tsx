...
export default ( /*{ loading, setLoading }*/ ) => {
  ...
  useEffect ( () => {
    console.log('[r][init product]', product);
  }, [] );
    ...
    <div className='py-6'>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6'>
        <div className='flex flex-col md:flex-row -mx-4'>
          ...
          <div className='md:flex-1 px-4'>
            <h2
              className='mb-2 leading-tight tracking-tight font-bold text-gray-800 text-2xl md:text-3xl'>{product?.title}</h2>
            <p className='text-gray-500 text-sm'>By <a href='#'
                                                       className='text-indigo-600 hover:underline'>{product?.category}</a>
            </p>
